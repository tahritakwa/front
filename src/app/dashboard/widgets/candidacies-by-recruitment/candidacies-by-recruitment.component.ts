...
@Component({
  selector: 'app-candidacies-by-recruitment',
  templateUrl: './candidacies-by-recruitment.component.html',
  styleUrls: ['./candidacies-by-recruitment.component.scss']
})
export class CandidaciesByRecruitmentComponent implements OnInit {
  ...
  initTopSupplierChart(periodEnum = DashboardConstant.DEFAULT_PERIOD_ENUM) {
    ...
    this.labels = ["Session Octobre 2020","Session Novembre 2020","Session Décembre 2020"];
    this.numbers = [45,20,35];
