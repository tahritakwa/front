...
@Component({
  selector: 'app-pager-treasury',
  templateUrl: './pager-treasury.component.html',
  styleUrls: ['./pager-treasury.component.scss']
})
export class PagerTreasuryComponent implements OnChanges {
