export class ClaimTypeConstant {
  ...
  public static GET_CLAIM_TYPE_LIST = 'getClaimTypeList';
  ...
  public static GET_CLAIM_TYPE = 'getClaimType';
  public static GET_CLAIM_LINE_LIST = 'getClaimLine';
  public static TYPE_CLAIM = 'TYPE_CLAIM';

  public static SAVE = 'insertClaimType';
  public static GET_CLAIM_TYPE_BY_ID = 'getClaimTypeById/';
  public static UPDATE = 'updateClaimType';
  public static DELETE = 'deleteClaimType';
