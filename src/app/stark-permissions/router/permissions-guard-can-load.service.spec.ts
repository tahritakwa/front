...
import { StarkPermissionsGuard } from './permissions-guard.service';
...
describe('Permissions guard only', () => {
    ...
    let permissionGuard: StarkPermissionsGuard;
    let route;
    let fakeRouter;
    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [StarkPermissionsModule.forRoot()]
        });
    });
    beforeEach(inject([StarkPermissionsService, StarkRolesService], (service: StarkPermissionsService, rolesService: StarkRolesService) => {
        fakeRouter = <any>{navigate: () => {}};
        spyOn(fakeRouter, 'navigate');

        service.addPermission('ADMIN');
        permissionGuard = new StarkPermissionsGuard(service, rolesService, fakeRouter as Router);
    }));
...
describe('Permissions guard Except and only together with isolation in root', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [StarkPermissionsModule.forRoot({permissionsIsolate: true, rolesIsolate: true})]
        });
    });
    beforeEach(inject([StarkPermissionsService, StarkRolesService], (service: StarkPermissionsService, rolesService: StarkRolesService) => {
        fakeRouter = <any>{navigate: () => {}};
...
describe('Permissions guard use only dynamically', () => {
    ...
    beforeEach(inject([StarkPermissionsService, StarkRolesService], (service: StarkPermissionsService, rolesService: StarkRolesService, router: Router) => {
        fakeRouter = <any>{navigate: () => {}};
