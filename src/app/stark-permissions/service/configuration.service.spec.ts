...
import { StarkPermissionsConfigurationService } from './configuration.service';
...
describe('Configuration Service', () => {
    let localService: StarkPermissionsConfigurationService;
    ...
    beforeEach(inject([StarkPermissionsConfigurationService], (service: StarkPermissionsConfigurationService) => {
