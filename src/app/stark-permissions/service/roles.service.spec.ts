import { StarkRolesService } from './roles.service';
...
describe('Roles Service', () => {
    let localService: StarkRolesService;
    let permissionsService: StarkPermissionsService;
    ...
    beforeEach(inject([StarkRolesService, StarkPermissionsService], (service: StarkRolesService, ps: StarkPermissionsService) => {
...
describe('Roles Service model', () => {
   it('should create role mode', () => {
       const roleModel = new StarkRole('role', () => true);
