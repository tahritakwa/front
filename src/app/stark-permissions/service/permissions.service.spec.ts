...
describe('Permissions Service', () => {
    let localService: StarkPermissionsService;
    beforeEach(() => {
    ...
    beforeEach(inject([StarkPermissionsService], (service: StarkPermissionsService) => {
...
describe('Permissions Service model', () => {
    it('should create role mode', () => {
        let permission = new StarkPermission('permission', () => true);
