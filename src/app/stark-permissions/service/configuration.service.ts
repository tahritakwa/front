...
import {
    StarkPermissionsPredefinedStrategies,
...
@Injectable()
export class StarkPermissionsConfigurationService {
    ...
    constructor(
        ...
        private configurationStore: StarkPermissionsConfigurationStore
    ) {
    ...
    private predefinedStrategy(strategy: string): boolean {
        return strategy === StarkPermissionsPredefinedStrategies.SHOW || strategy == StarkPermissionsPredefinedStrategies.REMOVE;
    }
}
